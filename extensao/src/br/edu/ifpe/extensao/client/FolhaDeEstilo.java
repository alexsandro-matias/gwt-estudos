...
public class FolhaDeEstilo implements EntryPoint
{
	...
	/***
	 * 
	 * // Esta parte é criada como projeto de exemplo.Linha toda comentada para
	 * ser // feita do zero. Todo este corpo deve está // dentro de Extensao. //
	 * // sugestão de exclusão destes atributos. // // /** // // * The message
	 * displayed to the user when the server cannot be reached // or // // *
	 * returns an error. // //
	 */
